...
- The mark is printed centre chest at 36% of the shirt's width. That only works because the kits carry no lettering; an earlier set had the ticker printed across the middle and every crest position collided with it.
- A mark's colour is per kit and has to be checked against the pattern it lands on, not just the body colour. Nvidia's mark sits on the black chevron and Strategy's on a black hoop, so both are printed white even though their bodies are light.
- A white or near-white kit body cannot be cut out: the background flood has no edge to stop at and eats the shirt. It happened to SanDisk, then to Alphabet. Give those kits a grey or coloured body.
